...
public abstract class BaseApp {
    ...
    public void start(int port, int parallelism, String ckAndGroupId, String topic) {
        ...
        // 1.4.4 checkpoint 存储
        env.getCheckpointConfig().setCheckpointStorage("hdfs://ns1/checkpoint/" + ckAndGroupId);
        ...
        DataStreamSource<String> KafkaStream = env.fromSource(source, WatermarkStrategy.noWatermarks(), "kafka_source");
